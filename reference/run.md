...
the [process](http://processx.r-lib.org/reference/process.md) class.
...
- command:
  ...
  in the [process](http://processx.r-lib.org/reference/process.md)
  manual page.
...
- ...:
  ...
  [process](http://processx.r-lib.org/reference/process.md). Note that
  you cannot pass `stout` or `stderr` here, because they are used
  internally by `run()`. You can use the `stdout_callback`,
  `stderr_callback`, etc. arguments to manage the standard output and
  error, or the
  [process](http://processx.r-lib.org/reference/process.md) class
...
[process](http://processx.r-lib.org/reference/process.md) object. You
can manipulate this object, for example you can call `$kill()` on it to
terminate it, as a response to a message on the standard output or
error.
