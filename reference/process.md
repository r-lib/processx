...
[`poll()`](http://processx.r-lib.org/reference/poll.md) function can
...
- `poll_connection`:
  ...
  [`poll()`](http://processx.r-lib.org/reference/poll.md). The numeric
  file descriptor of the poll connection comes right after `stderr` (2),
  and the connections listed in `connections`.
...
[`poll()`](http://processx.r-lib.org/reference/poll.md) function to poll
