# reading unaccepted server socket is error
    ...
    Condition
      ...
      Caused by error in `chain_call(c_processx_connection_read_chars, con, n)` at connections.R:294:39:
...
# errors
    ...
    Condition
      ...
      Caused by error in `chain_call(c_processx_connection_create_socket, filename, encoding)` at connections.R:577:39:
    ...
    Condition
      ...
      Caused by error in `chain_call(c_processx_connection_connect_socket, filename, encoding)` at connections.R:599:39:
