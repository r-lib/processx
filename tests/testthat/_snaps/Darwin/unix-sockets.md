...
# errors
    ...
    Condition
      ...
      Caused by error in `chain_call(c_processx_connection_create_socket, filename, encoding)` at connections.R:590:<col>:
    ...
    Condition
      ...
      Caused by error in `chain_call(c_processx_connection_connect_socket, filename, encoding)` at connections.R:612:<col>:
