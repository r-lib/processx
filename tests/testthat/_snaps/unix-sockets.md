# CRUD
    ...
    Condition
      ...
      Caused by error in `chain_call(c_processx_connection_accept_socket, con)` at connections.R:625:<col>:
...
# writing unaccepted server socket is error
    ...
    Condition
      ...
      Caused by error in `chain_call(c_processx_connection_write_bytes, con, str)` at connections.R:396:<col>:
...
---
    ...
    Condition
      ...
      Caused by error in `chain_call(c_processx_connection_socket_state, con)` at connections.R:637:<col>:
