...
- [`run()`](http://processx.r-lib.org/dev/reference/run.md) : Run
  external command, and wait until finishes
...
- [`curl_fds()`](http://processx.r-lib.org/dev/reference/curl_fds.md) :
...
- [`conn_create_fd()`](http://processx.r-lib.org/dev/reference/processx_connections.md)
  ...
  [`processx_conn_is_incomplete()`](http://processx.r-lib.org/dev/reference/processx_connections.md)
  [`conn_write()`](http://processx.r-lib.org/dev/reference/processx_connections.md)
  [`processx_conn_write()`](http://processx.r-lib.org/dev/reference/processx_connections.md)
  ...
  [`conn_get_fileno()`](http://processx.r-lib.org/dev/reference/processx_connections.md)
  [`conn_disable_inheritance()`](http://processx.r-lib.org/dev/reference/processx_connections.md)
  [`close(`*`<processx_connection>`*`)`](http://processx.r-lib.org/dev/reference/processx_connections.md)
  [`processx_conn_close()`](http://processx.r-lib.org/dev/reference/processx_connections.md)
  [`is_valid_fd()`](http://processx.r-lib.org/dev/reference/processx_connections.md)
...
- [`base64_decode()`](http://processx.r-lib.org/dev/reference/base64_decode.md)
  [`base64_encode()`](http://processx.r-lib.org/dev/reference/base64_decode.md)
